...
const producto1: Producto = new Producto(1, "Carne", 19.99);
const producto2: Producto = new Producto(2, "Leche", 9.99);
const producto3: Producto = new Producto(3, "Fruta", 4.99);
